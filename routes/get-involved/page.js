...
<main class="pt-20 min-h-screen">
  ...
  <section class="relative bg-gradient-to-br from-green-700 via-green-800 to-green-900 text-white py-24 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative">
      <div class="max-w-3xl">
        <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight">Get Involved with RevampIT</h1>
        <h2 class="text-2xl md:text-3xl font-semibold mb-8 text-green-200">Join our mission to extend the life of technology and support our community</h2>
        <p class="text-xl text-green-100">There are many ways to participate — from volunteering to forming partnerships. Below are a few options to get started.</p>
      </div>
    </div>
  </section>
